...
<body>
	...
	<div class="center">
		<div class="list-group">
			...
			<a href="updateemployee" class="list-group-item list-group-item-action">Update Employee Details </a>
			<a href="deleteemployee" class="list-group-item list-group-item-action">Delete Employee </a>
		</div>
	</div>
